...
namespace ocr {
	...
	private:
		...
		static inline const std::vector<std::string> suffixes = {"","file","filepath","file-path","file_path","path"};

		static inline const std::vector<std::string> root_alias = {"file_root","file_root_path","file-root","file-root-path","root","root_path","root-path", "model_root", "model_root_path", "model-root", "model-root-path"};
		...
		static inline const std::vector<std::string> key_alias = {"key","keys","letter","letters","character","characters","char","chars"};
